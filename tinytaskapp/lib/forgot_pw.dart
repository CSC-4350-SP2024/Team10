    ...
    try {
      ...
      showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              content: Text(
                  'We sent you an email with a link to reset your password. Please check your email. If you do not receive an email, check your spam folder or try again.'),
            );
          });
    } on FirebaseAuthException catch (e) {
      print(e.toString());
      if (e.code == 'user-not-found') {
        showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                content: Text(
                    'The provided email is not registered. Please check your email address and try again.'),
              );
            });
      } else {
        showDialog(
